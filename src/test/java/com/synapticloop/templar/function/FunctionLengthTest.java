...
import com.synapticloop.templar.bean.length.FieldLength;
import com.synapticloop.templar.bean.length.FieldNone;
import com.synapticloop.templar.bean.length.FieldSize;
import com.synapticloop.templar.bean.length.MethodGetLength;
import com.synapticloop.templar.bean.length.MethodGetSize;
...
public class FunctionLengthTest {
	...
	public void testValidLength() throws FunctionException {
		...
		Assert.assertEquals(MethodGetLength.RETURN_VALUE, functionLength.evaluate("", new Object[] {new MethodGetLength()}, null));
		Assert.assertEquals(MethodGetSize.RETURN_VALUE, functionLength.evaluate("", new Object[] {new MethodGetSize()}, null));
		Assert.assertEquals(FieldLength.RETURN_VALUE, functionLength.evaluate("", new Object[] {new FieldLength()}, null));
		Assert.assertEquals(FieldSize.RETURN_VALUE, functionLength.evaluate("", new Object[] {new FieldSize()}, null));
	}
}
