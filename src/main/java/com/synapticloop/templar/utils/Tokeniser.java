...
import com.synapticloop.templar.token.CommentToken;
import com.synapticloop.templar.token.DumpContextToken;
import com.synapticloop.templar.token.DumpFunctionsToken;
import com.synapticloop.templar.token.ElseToken;
import com.synapticloop.templar.token.EndIfToken;
import com.synapticloop.templar.token.EndLoopToken;
import com.synapticloop.templar.token.EscapeToken;
import com.synapticloop.templar.token.EvaluationToken;
import com.synapticloop.templar.token.IfToken;
import com.synapticloop.templar.token.ImportToken;
import com.synapticloop.templar.token.LoopToken;
import com.synapticloop.templar.token.NewLineToken;
import com.synapticloop.templar.token.PreToken;
import com.synapticloop.templar.token.RequiresToken;
import com.synapticloop.templar.token.SetToken;
import com.synapticloop.templar.token.StaticToken;
import com.synapticloop.templar.token.TabToken;
import com.synapticloop.templar.token.TextToken;
				...
				if(stringTokenizer.hasMoreTokens()) {
					...
					if(!TOKEN_MAP.containsKey(token)) {
						...
						case DUMPFUNCTIONS:
							...
							break;
						case REQUIRES:
							tokens.add(new RequiresToken("", stringTokenizer, this));
							break;
						case ELSE:
						...
						case ENDLOOP:
							...
							return(tokens);
						case STATIC:
							tokens.add(new StaticToken("", stringTokenizer, this));
							break;
						case IMPORT:
