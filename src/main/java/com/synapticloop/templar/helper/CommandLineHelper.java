...
import com.synapticloop.templar.token.command.CommandDoubleQuoteToken;
import com.synapticloop.templar.token.command.CommandEvaluationToken;
import com.synapticloop.templar.token.command.CommandFunctionToken;
import com.synapticloop.templar.token.command.CommandLineToken;
import com.synapticloop.templar.token.command.CommandNotToken;
import com.synapticloop.templar.token.command.CommandSingleQuoteToken;
